...
def format_forecast_to_llm_context(forecast: "SurfForecast") -> str:
    ...
    sd = _fmt_int(cc.swell_wave_direction_deg) if cc.swell_wave_direction_deg is not None else "N/A"
    lines = [
    ...
    for day in forecast.forecast_5day:
        ...
        swell_dir = degrees_to_compass(day.swell_wave_direction_dominant_deg or 0).upper()
